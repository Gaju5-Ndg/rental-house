...
// upload image
     ...
     $errors= array();
     if(empty($errors)==true){
     $sql = "UPDATE  house SET filenames='$filenames',phone_number=' $phone_number',price='$price' WHERE house_id='$id'";
...
<div id="content" possition="center">
       ...
       <input type="text" name="filenames" placeholder="filenames" ><br>
